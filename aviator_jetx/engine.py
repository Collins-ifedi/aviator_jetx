...
class CrashGameEngine:
    ...
    def _generate_crash_point(self) -> Decimal:
        ...
        # Normalizing logic: (0.96 / (1 - rand)) roughly maps 0.5 -> 2.0x
        try:
    ...
    async def start_new_round(self) -> Dict:
        ...
        async with self._lock:
            ...
            # NOTE: We do NOT set flight_start_at yet. 
            # We wait for the bet trigger.
    ...
    async def get_current_state(self) -> Dict:
        ...
        async with self._lock:
            ...
            # Check for natural crash (Time-based)
            if self._round.state == GameState.FLYING:
